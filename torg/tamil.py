...
import pandas as pd
url ="https://tntenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,38):
    ...
    actual_web_links[i]="https://tntenders.gov.in"
