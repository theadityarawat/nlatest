...
import pandas as pd
url ="https://tendersodisha.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,47):
    ...
    actual_web_links[i]="https://tendersodisha.gov.in"
