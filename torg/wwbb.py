...
import pandas as pd
url ="https://wbtenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,125):
    ...
    actual_web_links[i]="https://wbtenders.gov.in"
...
# print(df)
df.to_csv('./torg/West Bengal.csv')
