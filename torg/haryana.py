...
import pandas as pd
url ="https://etenders.hry.nic.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,2):
    ...
    actual_web_links[i]="https://etenders.hry.nic.in"
