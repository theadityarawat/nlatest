...
import pandas as pd
url ="https://assamtenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,40):
    ...
    actual_web_links[i]="https://assamtenders.gov.in"
