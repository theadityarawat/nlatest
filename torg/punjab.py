...
import pandas as pd
url ="https://eproc.punjab.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,29):
    ...
    actual_web_links[i]="https://eproc.punjab.gov.in"
