...
import pandas as pd
url ="https://mizoramtenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,1):
    ...
    actual_web_links[i]="https://mizoramtenders.gov.in"
