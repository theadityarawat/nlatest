...
import pandas as pd
url ="https://tripuratenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,30):
    ...
    actual_web_links[i]="https://tripuratenders.gov.in"
