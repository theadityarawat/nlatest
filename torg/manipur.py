...
import pandas as pd
url ="https://manipurtenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,8):
    ...
    actual_web_links[i]="https://manipurtenders.gov.in"
