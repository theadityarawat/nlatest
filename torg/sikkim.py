...
import pandas as pd
url ="https://sikkimtender.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,2):
    ...
    actual_web_links[i]="https://sikkimtender.gov.in"
