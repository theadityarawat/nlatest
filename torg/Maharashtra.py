...
import pandas as pd
url ="https://mahatenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,165):
    ...
    actual_web_links[i]="https://mahatenders.gov.in"
...
# print(df)
df.to_csv('./torg/Maharashtra.csv')
