...
import pandas as pd
url ="https://mptenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,79):
    ...
    actual_web_links[i]="https://mptenders.gov.in"
