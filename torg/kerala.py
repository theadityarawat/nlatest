...
import pandas as pd
url ="https://etenders.kerala.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,121):
    ...
    actual_web_links[i]="https://etenders.kerala.gov.in"
