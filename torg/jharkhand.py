...
import pandas as pd
url ="https://jharkhandtenders.gov.in/nicgep/app?page=FrontEndTendersByOrganisation&service=page"
...
for i in range(0,33):
    ...
    actual_web_links[i]="https://jharkhandtenders.gov.in"
